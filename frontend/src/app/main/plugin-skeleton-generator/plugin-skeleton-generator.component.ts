...
@Component({
  selector: 'app-plugin-skeleton-generator',
  templateUrl: './plugin-skeleton-generator.component.html',
  styleUrls: ['./plugin-skeleton-generator.component.scss', '../../app.component.scss']
})
export class PluginSkeletonGeneratorComponent implements OnInit {
  pluginNameForm = this.fb.group({
    syliusVersion: ['1.11', Validators.required],
